# Generated by Django 3.2.7 on 2021-09-24 03:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tagline', models.CharField(default='', max_length=100, verbose_name='Tags')),
                ('description', models.TextField(verbose_name='Description')),
                ...
                ('budget', models.PositiveSmallIntegerField(default=0, help_text='Add value in dollars', verbose_name='Budget')),
                ('fees_in_usa', models.PositiveSmallIntegerField(default=0, help_text='Add value in dollars', verbose_name='Box office in USA')),
                ('fees_in_world', models.PositiveSmallIntegerField(default=0, help_text='Add value in dollars', verbose_name='Box office in the world')),
                ('url', models.SlugField(max_length=160, unique=True)),
